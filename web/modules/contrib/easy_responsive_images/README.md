...
## Requirements
This module requires the Drupal core Image module.
...
## Configuration
Go to `admin/config/media/image-styles/generate` to generate the image styles.
...
## Uninstallation
1. If you want to delete the generated image styles, first make sure they aren't used anymore. After that, visit `admin/config/media/image-styles/generate` and click 'Delete generated image styles'. 
2. Go to the module list (admin/modules) and uninstall the module.
